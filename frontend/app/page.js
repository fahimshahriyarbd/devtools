...
import { FileArchive, FolderTree, GitCompareArrows, Wifi, Share2, ArrowRight, Sparkles, Zap, Shield, Globe, Layers, Activity, Braces, Github, Heart, Mail, Hash, Dice5, Send } from 'lucide-react';
...
const tools = [
  {
    href: '/rest-client',
    title: 'API Client',
    desc: 'Postman-style REST tester with tabs, collections, environments, code snippets, and JavaScript tests. 100% local.',
    icon: Send,
