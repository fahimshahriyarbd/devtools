        ...
        >
          ...
          <div className={cn('relative border-b border-border/60 shrink-0', collapsed ? 'p-3' : 'p-5')}>
            <Link href="/" className={cn('flex items-center', collapsed ? 'justify-center' : 'gap-2.5')}>
              <div className="relative h-9 w-9 rounded-xl bg-gradient-to-br from-blue-500 via-violet-500 to-fuchsia-500 grid place-items-center shadow-lg shadow-violet-500/20 shrink-0">
                <Sparkles className="h-4 w-4 text-white" />
              </div>
              {!collapsed && (
                <div className="min-w-0">
                  <div className="font-semibold text-[15px] leading-tight">DevHub</div>
                  <div className="text-[11px] text-muted-foreground leading-tight">Developer Utilities</div>
                </div>
              )}
            </Link>
            <button
