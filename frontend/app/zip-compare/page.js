...
export default function ZipComparePage() {
  ...
  // archive changes identity (cleared and re-added, or swapped for a
  // different file). Otherwise rows from a completely new pair would
    ...
    <div className="flex flex-col h-screen">
      <header className="flex flex-wrap items-center gap-3 p-4 border-b border-border/60 bg-card/40 backdrop-blur">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {(left || right) && (
            <Button
              data-testid="zip-clear-both-btn"
              size="sm"
              variant="outline"
              onClick={() => {
                setLeft(null);
                ...
                setSearch('');
                setFilter('all');
                toast.success('Cleared both archives');
              }}
